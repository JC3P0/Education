/* BinaryTree.h - Exercise the functions in the BinaryTree class (from the textbook)
 * Author:     Chris Merrill
 * Module:     16
 * Project:    Demonstration
 * Description: Full description of BinaryTree class (from textbook) converted to
 *    a generic class
 *
 * Public Functions:
 *     - constructor(value)
...
//**************************************************
template<typename T>
void BinaryTree<T>::insert(TreeNode * &tree, T data) {
...
//********************************************
template<typename T>
void BinaryTree<T>::remove(TreeNode *&tree, T data) {
...
//*************************************************
template<typename T>
void BinaryTree<T>::toVector(vector<T> *vect, TreeNode *tree) const {
    if (tree) {
