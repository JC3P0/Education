/* BinaryTree.h - Header file for BinaryTree class
 * Author:     Chris Merrill
 * Module:     16
 * Project:    Demonstration
 * Description: Used the IntBinaryTree class from the textbook,
...
#ifndef EBINARY_TREE_H
#define EBINARY_TREE_H
...
private:
    ...
    // The TreeNode struct is used to build the tree.  It is internal to the BinaryTree
...
//****************************************************
// Displays the values stored in prenorder sequence. *
//****************************************************
template<typename T>
...
int EBinaryTree<T>::getDiameter(TreeNode *tree) const {
    ...
    // find the maximum of left subtree diameter,
    // right subtree diameter, and longest path which
    // goes up to or through root of this (sub)tree
