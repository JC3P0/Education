public class PokemonBox {
	...
	public PokemonBox(Pokemon[] caught) throws IllegalArgumentException {
		if(caught == null || caught.length == 0) {
            throw new IllegalArgumentException("Invalid pokemon array provided to pokembox.");
	...
	public void add(Pokemon newPoke) throws PokemonAlreadyExistsException{ //throws PokemonAlreadyExistsException
        ...
        if (this.hasPokemon(newPoke.getName())){
            ...
            try {
                ...
                System.out.println("Error trying to copy null pokemon in pokebox");
                System.exit(0);
            }
        }
	}
