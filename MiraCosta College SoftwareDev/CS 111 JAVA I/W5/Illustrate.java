...
public class Illustrate
{
    ...
    //Method to return the value of the instance and static variables as a string.
    //The string returned is used by the methods print, println, or printf  to print the values
